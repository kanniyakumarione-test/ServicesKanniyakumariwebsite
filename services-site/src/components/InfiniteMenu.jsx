  ...
  return (
    <div className="relative w-full h-full bg-[#0a0a0a]">
      <div className="absolute inset-0 z-0 opacity-60">
        <Scanner color1="#fbbf24" color2="#b45309" color3="#0a0a0a" scanDirection="diagonal" />
      </div>
      <canvas
      ...
      {activeItem && (
        <>
          <h2
            className={`
          select-none absolute font-display font-black text-white z-20
          text-3xl md:text-5xl left-[5%] md:left-[8%] top-[10%] md:top-[40%] transform
          md:-translate-y-1/2 transition-all ease-[cubic-bezier(0.25,0.1,0.25,1.0)] drop-shadow-[0_0_15px_rgba(0,0,0,0.8)]
          max-w-[80vw] md:max-w-[35vw] leading-tight
          ${
            isMoving
        ...
        `}
          ...
          <p
            className={`
          select-none absolute max-w-sm text-gray-300 drop-shadow-[0_0_10px_rgba(0,0,0,0.8)] z-20
          text-sm md:text-base bottom-[15%] md:top-[60%] md:bottom-auto left-[5%] md:left-[8%]
        ...
        `}
          ...
          <div
            ...
            className={`
          absolute left-1/2 z-20 w-[60px] h-[60px] grid place-items-center
          bg-amber-500 border-[3px] border-amber-900 rounded-full
          cursor-pointer transition-all ease-[cubic-bezier(0.25,0.1,0.25,1.0)]
          hover:bg-amber-400 hover:scale-110 shadow-[0_0_20px_rgba(245,158,11,0.4)]
          ${
            isMoving
              ? 'bottom-[-80px] opacity-0 pointer-events-none duration-[100ms] scale-0 -translate-x-1/2'
              : 'bottom-[10%] md:bottom-[5%] opacity-100 pointer-events-auto duration-[500ms] scale-100 -translate-x-1/2'
          }
        `}
          >
            <p className="select-none relative text-black top-[2px] text-[26px] font-bold">&#x2197;</p>
          </div>
        </>
      )}
    </div>
