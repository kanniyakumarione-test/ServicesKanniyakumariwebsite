...
void main() {
  ...
  // Calculate normalized x from -0.5 to 0.5 to make the envelope span the entire width
  float nx = (gl_FragCoord.x / uResolution.x) - 0.5;
  ...
  // Eliminate the asymptotic glow tail that causes the faint bounding box
  col = max(col - 0.025, vec3(0.0));
